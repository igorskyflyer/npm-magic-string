...
Hello, thank you for using MagicString! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-magic-string/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-magic-string/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-magic-string/issues) using the appropriate issue template and with the label of `bug`,
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-magic-string/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-magic-string/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of MagicString:
...
<div align="center">
  Thank you for using MagicString!
  <br>
