...
describe('🧪 MagicString tests 🧪', () => {
  ...
  it('#2 should initialize with an initial accumulator', () => {
  ...
  it('#3 should append a value', () => {
    magicString.append('Hello')
    expect(magicString.value).toBe('Hello')
  }) // #3

  it('#4 should append a single-quoted value', () => {
    magicString.appendSingleQuoted('Hello')
    expect(magicString.value).toBe("'Hello'")
  }) // #4

  it('#5 should append a double-quoted value', () => {
    magicString.appendQuoted('Hello')
    expect(magicString.value).toBe('"Hello"')
  }) // #5

  it('#6 should trim all whitespace', () => {
    magicString.append('Hello   World')
    magicString.trimAll()
    expect(magicString.value).toBe('Hello World')
  }) // #6

  it('#7 should trim only leading and trailing whitespace', () => {
    magicString.append('   Hello    World   ')
    magicString.trim()
    expect(magicString.value).toBe('Hello    World')
  }) // #7

  it('#8 should enable and disable trimming', () => {
  ...
  it('#10 should prepend a value', () => {
    magicString.append('World').prepend('Hello')
    expect(magicString.value).toBe('Hello World')
  }) // #10

  it('#11 should convert to lower case', () => {
    magicString.append('HELLO').toLowerCase()
    expect(magicString.value).toBe('hello')
  }) // #11

  it('#12 should convert to upper case', () => {
    magicString.append('hello').toUpperCase()
    expect(magicString.value).toBe('HELLO')
  }) // #12

  it('#13 should clear the accumulator', () => {
